...
*/
    ...
    $.widget("ui.dropdownchecklist", {
        ...
        _appendControl: function() {
            ...
            var control = $("<span/>");
            control.addClass("ui-dropdownchecklist-selector ui-state-default1");
        ...
        _createDropItem: function(index, tabIndex, value, text, optCss, checked, disabled, indent) {
			...
			item.addClass("ui-state-default1");
			if (disabled) {
...
**********/	
		...
		_createCloseItem: function(text) {
			var self = this;
			var closeItem = $("<div />");
			closeItem.addClass("ui-state-default1 ui-dropdownchecklist-close ui-dropdownchecklist-item");
